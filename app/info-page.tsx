...
export function InfoPage({ title, intro, updated, sections }: {
  ...
  return <main className="info-page">
    ...
    <header className="info-hero"><h1>{title}</h1><div className="info-intro"><p>{intro}</p>{updated && <span>{updated}</span>}</div></header>
